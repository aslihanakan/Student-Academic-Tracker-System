            ...
            schemas: {
                ...
                Course: {
                    ...
                    properties: {
                        ...
                        credit: { type: "integer", minimum: 1, maximum: 10, example: 4 },
                        midtermGrade: { type: "integer", minimum: 0, maximum: 100, nullable: true, example: 78 },
                        projectGrade: { type: "integer", minimum: 0, maximum: 100, nullable: true, example: 85 },
                        finalGrade: { type: "integer", minimum: 0, maximum: 100, nullable: true, example: 90 }
                    }
                },
                CourseInput: {
                    type: "object",
                ...
                Exam: {
                    ...
                    properties: {
                        ...
                        examName: { type: "string", example: "Vize Sınavı" },
                        examDate: { type: "string", format: "date", example: "2026-04-15" },
                        examType: {
                            type: "string",
                            enum: ["midterm", "final", "quiz", "other"],
                            example: "midterm"
                        },
                        score: { type: "integer", minimum: 0, maximum: 100, nullable: true, example: 82 }
                    }
                },
                ExamInput: {
                    type: "object",
                    required: ["courseId", "examName", "examDate", "examType"],
                    properties: {
                        courseId: { type: "integer", example: 1 },
                        examName: { type: "string", example: "Vize Sınavı" },
                        examDate: { type: "string", format: "date", example: "2026-04-15" },
                ...
                Project: {
                    ...
                    properties: {
                        id: { type: "integer", example: 1 },
                        courseId: { type: "integer", example: 1 },
                        projectName: { type: "string", example: "Final Projesi" },
                        dueDate: { type: "string", format: "date", example: "2026-05-20" },
                        description: { type: "string", nullable: true, example: "REST API tabanlı bir uygulama geliştirilecek." },
                        score: { type: "integer", minimum: 0, maximum: 100, nullable: true, example: 95 },
                        status: {
                            type: "string",
                ...
                ProjectInput: {
                    type: "object",
                    required: ["courseId", "projectName", "dueDate"],
                    properties: {
                        courseId: { type: "integer", example: 1 },
                        projectName: { type: "string", example: "Final Projesi" },
                        dueDate: { type: "string", format: "date", example: "2026-05-20" },
                ...
                StudySession: {
                    ...
                    properties: {
                        id: { type: "integer", example: 1 },
                        courseId: { type: "integer", example: 1 },
                        studyDate: { type: "string", format: "date", example: "2026-03-10" },
                        hours: { type: "number", format: "float", minimum: 0, exclusiveMinimum: true, example: 2.5 },
                        note: { type: "string", nullable: true, example: "Konu tekrarı yapıldı." }
                    }
                },
                StudySessionInput: {
                    type: "object",
                    required: ["courseId", "studyDate", "hours"],
                    properties: {
                        courseId: { type: "integer", example: 1 },
                        studyDate: { type: "string", format: "date", example: "2026-03-10" },
                        hours: { type: "number", format: "float", minimum: 0, exclusiveMinimum: true, example: 2.5 },
                ...
                TotalStudyHours: {
                    type: "object",
                    properties: {
                        totalHours: { type: "number", format: "float", example: 24.5 }
                    }
                },
                Todo: {
                    type: "object",
                    properties: {
                        id: { type: "integer", example: 1 },
                        courseId: { type: "integer", example: 1 },
                        type: { type: "string", enum: ["exam", "project"], example: "exam" },
                        title: { type: "string", example: "Vize sınavına çalış" },
                        dueDate: { type: "string", format: "date", example: "2026-04-15" },
                        isDone: { type: "integer", enum: [0, 1], example: 0 }
                    }
                },
                TodoInput: {
                    type: "object",
                    required: ["courseId", "type", "title", "dueDate"],
                    properties: {
                        courseId: { type: "integer", example: 1 },
                        type: { type: "string", enum: ["exam", "project"], example: "exam" },
                        title: { type: "string", example: "Vize sınavına çalış" },
                ...
                TodoStatusInput: {
                    ...
                    required: ["isDone"],
                    properties: {
                        isDone: { type: "integer", enum: [0, 1], example: 1 }
                    }
                },
                DashboardSummary: {
                    type: "object",
                    ...
                    properties: {
                        ...
                        totalExams: { type: "integer", example: 12 },
                        totalProjects: { type: "integer", example: 4 },
                        totalStudyHours: { type: "number", example: 38.5 },
                        nearestTodo: { $ref: "#/components/schemas/Todo" }
                    }
                },
                MessageResponse: {
                    type: "object",
