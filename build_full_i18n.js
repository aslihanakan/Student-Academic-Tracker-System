...
const RAW_DICTIONARY = {
    ...
    auth_success_auto_login: { en: 'You are being logged in automatically, please wait...', tr: 'Oturumunuz otomatik olarak açılıyor, lütfen bekleyiniz...', de: 'Du wirst automatisch eingeloggt, bitte warten...', es: 'Iniciando sesión automáticamente, por favor espera...', fr: 'Connexion automatique en cours, veuillez patienter...', it: 'Accesso automatico in corso, attendere...', ru: 'Выполняется автоматический вход, пожалуйста, подождите...', ko: '자동으로 로그인 중입니다. 잠시만 기다려주세요...', ja: '自動的にログインしています。しばらくお待ちください...', ar: 'جارٍ تسجيل الدخول تلقائياً، يرجى الانتظار...' },
    auth_continue_app: { en: 'Continue to App ➔', tr: 'Uygulamaya Devam Et ➔', de: 'Weiter zur App ➔', es: 'Continuar a la Aplicación ➔', fr: 'Continuer vers l\'application ➔', it: 'Continua all\'applicazione ➔', ru: 'Перейти в приложение ➔', ko: '앱으로 계속하기 ➔', ja: 'アプリに進む ➔', ar: 'المتابعة إلى التطبيق ➔' },
